...
import { HorizontalWire, Gate } from "./LogicAppStyles";
...
const lightGate = require('../gate-images/not-light.png');
const darkGate = require('../gate-images/not-dark.png');
...
const NotGate = (props) => {
  ...
  return (
    <>
      <h2>NOT Gate Logic</h2>
      <p>
        A not gate simply inverts the input, making the output opposite of the input.
      </p>
      <h3>Truth Table</h3>
      <div>
        <TruthTable theme={props.theme}>
          ...
          <TruthTableBody colSpan={2} theme={props.theme}>
            <TruthTableCurrentRow current={!buttonState} theme={props.theme}>
              <td>0</td><TruthTableOutputCell theme={props.theme}>1</TruthTableOutputCell>
            </TruthTableCurrentRow>
            <TruthTableCurrentRow current={buttonState} theme={props.theme}>
              <td>1</td><TruthTableOutputCell theme={props.theme}>0</TruthTableOutputCell>
            </TruthTableCurrentRow>
          </TruthTableBody>
        </TruthTable>
      </div>
      <FlexRowDiv style={{ marginTop: '50px', width: '100vw', justifyContent: 'center' }}>
        ...
        <Gate src={props.theme === 'light' ? lightGate : darkGate} theme={props.theme} mobile={props.mobile} />
        <HorizontalWire theme={props.theme} mobile={props.mobile} active={!buttonState} style={{ width: props.mobile ? '50px' : '200px', marginTop: props.mobile ? '30px' : '76px' }} />
