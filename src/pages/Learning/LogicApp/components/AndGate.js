...
const lightGate = require('../gate-images/and-light.png');
const darkGate = require('../gate-images/and-dark.png');
...
const AndGate = (props) => {
  ...
  return (
    <>
      <h2>AND Gate Logic</h2>
      <p>
        An AND gate will provide a true output ONLY if both inputs are active.
      </p>
      <h3>Truth Table</h3>
      <div>
