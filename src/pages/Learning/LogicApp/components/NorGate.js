...
const lightGate = require('../gate-images/nor-light.png');
const darkGate = require('../gate-images/nor-dark.png');
...
const NorGate = (props) => {
  ...
  return (
    <>
      <h2>NOR Gate Logic</h2>
      <p>
        A NOR gate will provide the exact inverse of an OR gate.
      </p>
      <h3>Truth Table</h3>
      <div>
        <TruthTable theme={props.theme}>
          ...
          <TruthTableBody colSpan={3} theme={props.theme}>
            ...
            <TruthTableCurrentRow current={buttonState === 1} theme={props.theme}>
              <td>0</td><td>1</td><TruthTableOutputCell theme={props.theme}>0</TruthTableOutputCell>
            </TruthTableCurrentRow>
            <TruthTableCurrentRow current={buttonState === 2} theme={props.theme}>
              <td>1</td><td>0</td><TruthTableOutputCell theme={props.theme}>0</TruthTableOutputCell>
            </TruthTableCurrentRow>
      ...
      <FlexRowDiv style={{ marginTop: '50px', width: '100vw', justifyContent: 'center' }}>
        ...
        <HorizontalWire theme={props.theme} mobile={props.mobile} active={buttonState === 0} style={{ width: props.mobile ? '50px' : '200px', marginTop: props.mobile ? '124px' : '220px' }} />
        <OutputLight theme={props.theme} mobile={props.mobile} isActive={buttonState === 0} style={{ marginTop: props.mobile ? '112px' : '195px' }} />
      </FlexRowDiv>
    </>
  )
}
