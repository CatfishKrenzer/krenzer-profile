...
const lightGate = require('../gate-images/or-light.png');
const darkGate = require('../gate-images/or-dark.png');
...
const OrGate = (props) => {
  ...
  return (
    <>
      <h2>OR Gate Logic</h2>
      <p>
        An OR gate will provide a true output if any or both inputs are true.
      </p>
      <h3>Truth Table</h3>
      <div>
        <TruthTable theme={props.theme}>
          ...
          <TruthTableBody colSpan={3} theme={props.theme}>
            ...
            <TruthTableCurrentRow current={buttonState === 3} theme={props.theme}>
              <td>1</td><td>1</td><TruthTableOutputCell theme={props.theme}>1</TruthTableOutputCell>
            </TruthTableCurrentRow>
          </TruthTableBody>
        </TruthTable>
      </div>
